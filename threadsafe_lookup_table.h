...
#ifndef TEST_THREADSAFE_LOOKUP_TABLE_H
#define TEST_THREADSAFE_LOOKUP_TABLE_H
...
private:
    ...
    public:
        ...
        void add_or_update_mapping(Key const& key, Value const& value) {
            ...
            bucket_iterator const fount_entry = find_entry_for(key);
            if(fount_entry == data.end()) {
                data.push_back(bucket_value(key, value));
            } else {
                fount_entry->second = value;
            }
        }
...
#endif //TEST_THREADSAFE_LOOKUP_TABLE_H
